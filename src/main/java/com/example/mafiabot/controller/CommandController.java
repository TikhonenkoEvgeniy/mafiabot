...
public class CommandController {
    ...
    private SendMessage help(Update update) {
        final String infoText = "Очередность действий ночью:\n\n" +
                ...
                "3. «Дон» выбирает одного из игроков и проверяет его на принадлежность к полицейскому (если действия персонажа заморожены ему дают знак \uD83D\uDE45\u200D♂️, если Дон угадывает полицейского, то \uD83D\uDC4D\n\n" +
